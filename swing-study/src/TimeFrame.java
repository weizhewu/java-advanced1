...
public class TimeFrame extends JFrame {
    ...
    private void init() {
        ...
        imgPanel1.setImgPath("bj2.jpg");
        imgPanel1.setBounds(195, 180, 600, 400);
        numberLabel = new JLabel();
        numberLabel.setBounds(280, 150, 300, 100);
...
class ShadePanel1 extends JPanel {
    ...
    protected void paintComponent(Graphics g1) {
        ...
        //创建填充模式对象
        GradientPaint paint = new GradientPaint(0, 0, Color.GREEN, 0, height, Color.pink);
        g.setPaint(paint);
